		                	...
		                	<table style="width: 100%">
		                		...
		                		<tbody>
				                    ...
				                    <tr>
			                            ...
			                            <td><?php echo $_SESSION['itmname'] = $itmr['item_name']; ?></td>
          	...
          	<form action="manage-insert.php" method="POST">
                ...
                <div class="form-group">
                  <input type="text" name="transaction_id" class="form-control" placeholder="Transaction Id" required="">
	                ...
	                <input type="hidden" name="reservation_email" value="<?php echo $reservation_time; ?>">
                  ...
                  <input type="hidden" name="qty[]" value="<?php echo $qty; ?>">
	                <?php } ?>
	                <input type="hidden" name="item_name" value="<?php echo $_SESSION['itmname']; ?>">
